        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              {/* Interest Rate (Fixed) */}
              <label className={`block mb-2 font-medium ${labelColor}`}>Interest Rate (%)</label>
              <div className={`text-lg font-semibold mb-6 w-28 px-8 py-2 rounded-lg border ${inputBorder} ${inputBg} ${titleColor}`}>7.1%</div>
