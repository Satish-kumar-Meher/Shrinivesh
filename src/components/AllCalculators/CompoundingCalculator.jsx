...
const CompoundInterestCalculator = () => {
  ...
  const pieData = [
    { name: "Investment", value: principal, color: "#0e6371" },
  ...
  return (
    <section className={`relative mt-15 z-0 py-20 overflow-hidden transition-colors duration-500 ${bgGradient}`}>
      <SEO tittle={"Compounding Calculator Page"} description={"This is the compounding calculator page"} />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        >
          <h2 className={`text-2xl sm:text-3xl font-bold mb-6 ${titleColor}`}>Compound Interest Calculator</h2>

          <div className="grid md:grid-cols-2 gap-8 items-center">
            {/* Left Section */}
            <div>
              {/* Principal Amount */}
              <label className={`block mb-2 font-medium ${labelColor}`}>Principal Amount (₹)</label>
              ...
              <div className={`text-sm mb-4 ${hintColor}`}>Min: ₹1,000 | Max: ₹1 Crore</div>
              ...
              <p className={`mt-6 font-semibold italic ${titleColor}`}>
                Calculate compound growth of your investments
              </p>
            </div>
            ...
            <div className="flex flex-col items-center gap-4">
              <div className="flex gap-6 justify-center mb-2 text-center">
                <div>
                  <p className={`text-sm ${labelColor}`}>Investment</p>
                  <p className={`${titleColor} font-bold`}>₹ {principal.toLocaleString("en-IN")}</p>
                </div>
                <div>
                ...
                <div>
                  <p className={`text-sm ${labelColor}`}>Maturity Value</p>
                  <p className="text-blue-500 font-bold">₹ {maturityValue.toLocaleString("en-IN")}</p>
                </div>
              </div>
