    ...
    const fetchNews = async () => {
      try {
        const response = await fetch(
          `https://newsapi.org/v2/everything?q=mutual%20funds&language=en&sortBy=publishedAt&pageSize=6&apiKey=${apiKey}`
        );
...
//   const apiKey = "XG1RinsRDW8Ecp2u2Kzaw3tRdljWm8QmyFgj02FT";
...
//       try {
//         const response = await fetch(
//           `https://api.marketaux.com/v1/news/all?api_token=${apiKey}&language=en&limit=6&filter_entities=true&published_after=${new Date(
