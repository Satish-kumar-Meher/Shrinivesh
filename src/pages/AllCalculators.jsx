...
//   const bgGradient = darkMode
//     ? "bg-gradient-to-br from-[#0b0d1a] to-[#081c29]"
//     : "bg-gradient-to-br from-[#f9fcfe] to-[#e3f2ff]"; // pale sky blue
...
//             whileInView={{ opacity: 1, scale: 1 }}
//             transition={{ duration: 0.4, delay: index * 0.05 }}
//             className={`flex items-center text-left p-6 h-24 rounded-2xl border ${
//               darkMode ? "border-[#10e2ea]" : "border-[#0e6371]"
//             } cursor-pointer backdrop-blur-xl ${cardGlass} ${glow} transition duration-300 hover:scale-105`}
//           >
...
//               />
//             </div>
//             <h3 className={`text-lg sm:text-lg font-semibold ${textColor}`}>
//               {name}
//             </h3>
//           </motion.div>
//         ))}
