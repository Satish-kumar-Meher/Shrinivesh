...
const Goals = () => {
  ...
  // const overlayBg = darkMode ? "bg-[#10e2ea]/30" : "bg-[#0e6371]/30";
    ...
    const overlayBg = darkMode ? "bg-[#0f2a37]/60 border border-[#10e2ea]/20 " : "bg-[#0e6371]/30";


  const overlayTextColor = darkMode ? "text-white" : "text-white";
  const buttonStyle = darkMode
    ? "bg-[#10e2ea]/30 text-white border border-[#10e2ea]"
